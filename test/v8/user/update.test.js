...
test('PUT /v8/user returns 401 when not logged in', async t => {
...
test('PUT /v8/user returns 401 when not an admin for user', async t => {
...
test.todo('sketch out remaining tests')